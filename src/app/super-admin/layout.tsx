...
import { LayoutDashboard, Users, ClipboardList, Tag, User } from 'lucide-react';
...
const superAdminMenuItems: MenuItem[] = [
  ...
  { href: '/super-admin/profile', label: 'Profil Saya', icon: <User className="w-5 h-5" /> },
];
...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!isInitialized || !isAuthenticated || (user && user.role !== 'super_admin')) return null;
