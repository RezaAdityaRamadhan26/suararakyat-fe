  ...
  return (
    <div className="max-w-2xl mx-auto">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-1">Kelola informasi akun admin Anda</p>
      </motion.div>
        ...
        <div className="relative h-32 bg-gradient-to-br from-emerald-500 to-teal-600">
          <div className="absolute -bottom-10 left-6">
            <div className="flex items-center justify-center w-20 h-20 rounded-full bg-white p-1.5 shadow-md">
              <div className="flex items-center justify-center w-full h-full rounded-full bg-emerald-100">
        ...
        <div className="pt-14 px-6 pb-6">
          <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500 mb-8 pb-6 border-b border-slate-100">
            ...
            <span className="flex items-center gap-1.5">
              ...
              <span className="px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-semibold tracking-wide border border-emerald-200">
                Admin
              </span>
            </span>
          </div>
          ...
          <form onSubmit={handleSave} className="space-y-5">
            {/* Username */}
            <div>
              <label htmlFor="admin-profile-username" className="block text-sm font-medium text-slate-700 mb-1.5">Username</label>
            ...
            {/* Email */}
            <div>
              <label htmlFor="admin-profile-email" className="block text-sm font-medium text-slate-700 mb-1.5">Email</label>
              <div className="relative">
            ...
            <div className="pt-4 border-t border-slate-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="admin-profile-password" className="block text-sm font-medium text-slate-700 mb-1.5">Password Baru</label>
                  <input
                ...
                <div>
                  <label htmlFor="admin-profile-confirm-password" className="block text-sm font-medium text-slate-700 mb-1.5">Konfirmasi Password</label>
                  <input
            ...
            <div className="pt-6 flex justify-end">
              <button
                type="submit"
                disabled={isSaving}
                className="flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-xl transition-colors shadow-sm disabled:opacity-50"
              >
                {isSaving
