...
import { Megaphone, Eye, EyeOff, ArrowRight, FileText, MessageSquare, CheckCircle } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-lg">
            ...
            >
              Daftarkan akun Anda dan mulai sampaikan aspirasi untuk membangun
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500">
              Isi form di bawah untuk mendaftarkan akun Anda
            </p>
          </div>
